...
#H_real = H_sample_real[0]
#H_imag = H_sample_imag[0]
qc1, counts_sam,out, out1, out2 = Q_decode(h_ch, H_real, H_imag, w_1, w_2, w_3, w_4, w_5, w_6, shots=1024)
print("measurement_average_01 =",out[0])
print("measurement_average_02 =",out[1])
# %% loss function
...
def loss(N_BS, ch_gen, H_real, H_imag, w_1, w_2, w_3, w_4, w_5, w_6):
    ...
    qc1, counts_sam,out, out1, out2 = Q_decode(ch_gen, H_real, H_imag, w_1, w_2, w_3, w_4, w_5, w_6, shots=1024)
